...
next:     ldaa 0,x        ; get character
          cmpa #0         ; if character is terminating zero
          beq paddZero    ; padd zeros
...
paddZero:
          LDAA #' '       ; load space in A register
          jsr outputByte  ; print that character
          decb            ; decrement b as long as its
          beq paddZero    ; not zero
          bra wEnd
